...
cvx_begin SDP
%cvx_solver sedumi
     variable Wbar12(dIn^(2*k) dOut^(2*k)) complex semidefinite
     variable Wbar21(dIn^(2*k) dOut^(2*k)) complex semidefinite
     variable H(dIn^(2*k) dOut^(2*k)) complex semidefinite
     
     minimise trace(Wbar12)/dOut^k;
